...
public class FunctionExample2 {
    ...
    public static void main(String args[]){
        ...
        // use functional interface to solve the above one

        Predicate<Instructor> p1 = (i)->i.isOnlineCourses()==true;

        Function<List<Instructor>, Map<String, Integer>> function= instructors -> {
        ...
        System.out.println(function.apply(Instructors.getAll()));
    }
}
